...
public enum CoreSystemService {
	...
	MISMATCHANALYSIS_ANALYSIS_SERVICE(CommonConstants.CORE_SERVICE_MISMATCHANALYSIS_ANALYSIS, CommonConstants.MISMATCHANALYSIS_URI + CommonConstants.OP_MISMATCHANALYSIS_ANALYSIS_URI),
	...
	INTERFACEGENERATOR_GENERATE_SERVICE(CommonConstants.CORE_SERVICE_INTERFACEGENERATOR_GENERATE, CommonConstants.INTERFACEGENERATOR_URI + CommonConstants.OP_INTERFACEGENERATOR_GENERATE_URI);
