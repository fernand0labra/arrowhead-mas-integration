...
public class CommonConstants {
	...
	public static final String CORE_SYSTEM_MISMATCHANALYSIS = "Mismatch Analysis";
	
	/* ******************************************************************************************************** */
	/*                                	        interface-generator 											*/
	/* ******************************************************************************************************** */
	
	public static final String CORE_SYSTEM_INTERFACEGENERATOR = "Interface Generator";
	...
	/*                                           mismatch-analysis												*/
	/* ******************************************************************************************************** */
    public static final String CORE_SERVICE_MISMATCHANALYSIS_ANALYSIS = "analysis-service";
    
	/* ******************************************************************************************************** */
	/*                                	        interface-generator 											*/
	/* ******************************************************************************************************** */
    public static final String CORE_SERVICE_INTERFACEGENERATOR_GENERATE = "generation-service";
    ...
    public static final String MISMATCHANALYSIS_URI = "/mismatchanalysis";
    public static final String OP_MISMATCHANALYSIS_ANALYSIS_URI = "/analysis";
	...
	public static final String INTERFACEGENERATOR_URI = "/interfacegenerator";
	public static final String OP_INTERFACEGENERATOR_GENERATE_URI = "/generate";
	...
	public static final List<CoreSystemService> PUBLIC_CORE_SYSTEM_SERVICES = List.of(CoreSystemService.ORCHESTRATION_SERVICE, CoreSystemService.AUTH_PUBLIC_KEY_SERVICE,
																					  ...
																					  CoreSystemService.TRANSLATOR_SERVICE, //
	       																			  CoreSystemService.MISMATCHANALYSIS_ANALYSIS_SERVICE, //
	       																			  CoreSystemService.INTERFACEGENERATOR_GENERATE_SERVICE, //
