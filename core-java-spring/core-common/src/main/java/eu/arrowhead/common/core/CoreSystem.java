...
public enum CoreSystem {
	...
	MISMATCHANALYSIS(Defaults.DEFAULT_MISMATCHANALYSIS_PORT, List.of(CoreSystemService.MISMATCHANALYSIS_ANALYSIS_SERVICE)),
	
	/* ******************************************************************************************************** */
	/*                                	        interface-generator 											*/
	/* ******************************************************************************************************** */
	
	INTERFACEGENERATOR(Defaults.DEFAULT_INTERFACEGENERATOR_PORT, List.of(CoreSystemService.INTERFACEGENERATOR_GENERATE_SERVICE)),
