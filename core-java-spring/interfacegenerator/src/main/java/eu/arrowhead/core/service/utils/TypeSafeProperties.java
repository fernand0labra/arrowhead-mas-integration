...
public class TypeSafeProperties extends Properties {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5110377963212873530L;
	...
	public int getIntProperty(String key, int defaultValue) {
		...
		try {
			...
			System.out.println(val + " is not a valid number! Please fix the \"" + key
					+ "\" property! Using default value (" + defaultValue + ") instead!");
			return defaultValue;
		}
	}
