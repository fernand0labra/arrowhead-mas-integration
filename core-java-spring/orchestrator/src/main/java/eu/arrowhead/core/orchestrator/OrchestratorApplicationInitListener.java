...
public class OrchestratorApplicationInitListener extends ApplicationInitListener {
	...
	protected List<CoreSystemService> getRequiredCoreSystemServiceUris() {
		...
		final List<CoreSystemService> result = new ArrayList<>(6);
		...
		result.add(CoreSystemService.MISMATCHANALYSIS_ANALYSIS_SERVICE);
		
		/* ******************************************************************************************************** */
		/*                                              translator													*/
		/* ******************************************************************************************************** */
		
		result.add(CoreSystemService.TRANSLATOR_SERVICE);
		
		/* ******************************************************************************************************** */
		/*                                         interface-generator												*/
		/* ******************************************************************************************************** */
		
		result.add(CoreSystemService.INTERFACEGENERATOR_GENERATE_SERVICE);
